     ...
     <div class="contact_section">
         ...
         {if $contactTitle || $contactName || $contactAffiliation || $contactPhone || $contactEmail}
             <div class="contact primary">
                 ...
                 <span class="label">
                         {translate key="plugins.themes.ibsscustom.about.contacts.affiliation"}:
                     </span>
                 ...
                 <div class="phone">
                     <span class="label">
                         {translate key="plugins.themes.ibsscustom.about.contacts.tel"}:
                     </span>
                     <span class="value">
                         {$contactPhone|escape}
                     </span>
                 ...
                 <div class="email">
                 <span class="label">
                         {translate key="plugins.themes.ibsscustom.about.contacts.email"}:
                     </span>
